...
export const PayPalIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    <path d="M7.069 5.484c.184-1.129.85-1.64 1.782-1.64h5.613c3.221 0 5.252 1.84 4.545 5.174-.531 2.505-2.404 3.938-4.722 3.938h-2.149c-.689 0-1.043.344-1.226 1.129l-.662 2.875c-.129.56-.473.849-.982.849H6.132c-.508 0-.64-.289-.522-.849l2.226-9.642-.22-.964H7.07z" />
    <path d="M9.471 3.844c.184-1.129.85-1.64 1.782-1.64h5.613c3.221 0 5.252 1.84 4.545 5.174-.531 2.505-2.404 3.938-4.722 3.938h-2.149c-.689 0-1.043.344-1.226 1.129l-.662 2.875c-.129.56-.473.849-.982.849H8.532c-.508 0-.64-.289-.522-.849l2.226-9.642-.22-.964H9.47z" fillOpacity=".8"/>
  </svg>
);
