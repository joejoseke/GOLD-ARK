...
const TicketView: React.FC<TicketViewProps> = ({ ticket, userRole, onUpdateQuantity, onGoToPayment, onClose }) => {
  ...
  return (
    <div className="flex flex-col h-full bg-surface-card dark:bg-surface-dark-card text-text-main dark:text-text-dark-main">
      ...
      <div className="p-4 border-t border-gray-200 dark:border-gray-700 md:hidden grid grid-cols-2 gap-3">
        <button
        ...
        <button
          ...
          className="w-full bg-brand-primary text-white font-bold py-3 rounded-lg text-lg hover:bg-brand-secondary transition-colors disabled:bg-gray-400 dark:disabled:bg-gray-600 cursor-pointer disabled:cursor-not-allowed"
        >
          PAY
        </button>
      </div>
