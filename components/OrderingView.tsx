...
import { MagnifyingGlassIcon, Bars3Icon, TicketIcon, XCircleIcon } from './common/icons';
             ...
             <div className="p-4">
               <div className="relative">
                <input
                  ...
                  className="w-full pl-10 pr-10 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-surface-card dark:bg-surface-dark-card focus:outline-none focus:ring-2 focus:ring-brand-primary"
                />
